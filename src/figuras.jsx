...
function Figuras() {
    ...
    const limpiarTriangulo = () => {
        setBaseTriangulo("");
        setAlturaTriangulo("");
        setResultadoTriangulo("");
    };

    const limpiarRectangulo = () => {
        setBaseRectangulo("");
        setAlturaRectangulo("");
        setResultadoRectangulo("");
    };

    const limpiarCuadrado = () => {
        setLadoCuadrado("");
        setResultadoCuadrado("");
    };
